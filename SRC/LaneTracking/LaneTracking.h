...
protected:
	...
	cOutputPin 			m_oLaneDetailsOutput;
...
private: // private methods
	...
	tResult TransmitLaneDetails(vector<tFloat32> &details);
	...
	tInt16	GetAverage(tInt16 x, std::deque<tInt16> &Buffer, tUInt bufferSize);
...
private:
    ...
    //f�r HoughSearch
    sPoint      m_HoughpointsNear[2];
    sPoint      m_HoughpointsFar[2];
	tUInt8		m_HoughLineSizeCounterNear;
	tUInt8		m_HoughLineSizeCounterFar;

    // points and values for lane detection
    tInt16      m_sLaneCenter;
	...
	vector<Point2f> m_HoughGroup3;//mid line in right curve mode
	vector<Point2f> m_HoughGroup4;// right line in left curve mode

	tInt32 LaneType;
	

//Imagecut for Houghlines
	tInt16		m_nImagecutWidthLeftHough;
	tInt16		m_nImagecutWidthRightHough;
	tInt16		m_nImagecutHeightUpHough;
	tInt16		m_nImagecutHeightDownHough;

	tInt16		m_nImagecutWidthLeftHoughCurve;
	tInt16		m_nImagecutWidthRightHoughCurve;
	...
	tInt		m_nThresholdDirect;
    tInt        m_nBlindCounter;
    tInt        m_nBlindCounterFar;
    tInt        m_nDriveTime;
    tInt        m_nEmergencyStopTime;
	tInt		m_nDistRadiusLEFTImageUp;
//	tInt		m_nDistRadiusLEFTImageDown;
	tInt		m_nDistRadiusRIGHTImageUp;
//	tInt		m_nDistRadiusRIGHTImageDown;
	...
	tResult KeepAngle(IMediaSample* pMediaSample);
	...
	// KeepAngleInput
	cObjectPtr<IMediaTypeDescription> m_pBoolKeepAngleInput;
	tBufferID m_szIDBoolValueKeepAngleInput; 
	tBool m_bKeepAngleSet;
	tBool m_KeepAngle;
	...
	tBufferID m_szIDSignalValueLaneSpot1XOutput;
	tBufferID m_szIDSignalValueLaneSpot1YOutput;
	tBufferID m_szIDSignalValueLaneSpot2XOutput;
	tBufferID m_szIDSignalValueLaneSpot2YOutput;
	tBool m_bLaneOutputSet; 	
	tFloat32 m_LaneSpots[4];

	// remember last x-values
	vector<tInt16> m_xGroup1Straight;
	vector<tInt16> m_xGroup2NotRight;
	vector<tInt16> m_xGroup3Right;
	vector<tInt16> m_xGroup4Left;
