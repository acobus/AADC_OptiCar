#ifndef _ScaleTracking_FILTER_HEADER_
#define _ScaleTracking_FILTER_HEADER_

#define OID_ADTF_ScaleTracking  "adtf.Scale_tracking"
#define LT_POINTS_ARRAY_SIZE 640

class cScaleTracking : public adtf::cFilter,
                      public adtf::ISignalProvider
{
    
    ADTF_FILTER(OID_ADTF_ScaleTracking, "ScaleTracking", adtf::OBJCAT_DataFilter);    
...
public:
    ...
    cScaleTracking(const tChar*);
    virtual ~cScaleTracking();
