...

				{
					...
					if(temp1<x1)
					{
						if (m_xGroup2NotRight.empty() || abs(m_xGroup2NotRight.at(0)-temp1) < X_DEVIATION){
							x1=temp1;
						}else if(! (abs(m_xGroup2NotRight.at(0)-temp1) < X_DEVIATION) ){
							//LOG_INFO(cString::Format("abs(m_xGroup2NotRight.at(0)-temp1) = %i", abs(m_xGroup2NotRight.at(0)-temp1) ) );
						}
					}
					if(temp2<x2)
					{
						if (m_xGroup2NotRight.empty() || abs(m_xGroup2NotRight.at(1)-temp2) < X_DEVIATION){
							x2=temp2;
						}else if(! (abs(m_xGroup2NotRight.at(1)-temp2) < X_DEVIATION) ){
							//LOG_INFO(cString::Format("abs(m_xGroup2NotRight.at(1)-temp2) = %i", abs(m_xGroup2NotRight.at(1)-temp2) ) );
						}
					}
				}
