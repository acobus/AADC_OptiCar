...
private:
	...
	// VelocityInput
	cObjectPtr<IMediaTypeDescription> m_pVelocityInput;
	tBufferID m_szIDVelocityInput; 
	tBufferID m_szIDTimestampVelocityInput; 
...
protected:
	...
	tResult ProcessRealVelocity(IMediaSample* pMediaSample);
