...
CrossParkingFilter::CrossParkingFilter(const tChar* __info) : m_hazzardON(false), m_turnRightON(false), m_reverseON(false), m_finishParking(false), m_isParking(false)
{
